...
<template>
  <header class="header">
    ...
    <div class="profile-block" v-if="isAuth">
      ...
      <select class="profile-block-menu" name="profile-menu" id="profile-menu" @change="logout">
        <option class="profile-block-menu__item" :value="user">{{ user }}</option>
        <option class="profile-block-menu__item" value="logout">Log Out</option>
      </select>
    </div>
  </header>
</template>
